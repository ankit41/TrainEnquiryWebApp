...
if(isset($_POST['submit'])){
    ...
    $url="http://api.railwayapi.com/v2/rescheduled/date/$date/apikey/b8a97bdhch/";
...
<div class="container">
  <div class="jumbotron">
    ...
    <form class="form-inline" action="Rescheduled.php" method="post">
     <h4>List Of Rescheduled Train</h4>
...
<div id="content">
  <h3>How to use the form</h3>
   <p>Select date from the given form and click on search. You will get the desired redult. If you want to look for particular train then press <kbd>ctrl + f</kbd>.A dialog box will apear on the top-right corner of the browser ,enter the train number you are looking for and press enter. If the train is reschuduled then it will be available in the table with highlighted mark</p>
   <br>
